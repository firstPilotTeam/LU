...
<head>
    ...
    <link rel="stylesheet" href="lib/layui/css/modules/style.css">
    <link rel="icon" href="lib/layui/css/modules/layer/default/icon.png">
    ...
    <form class="layui-form">
        <div class="layui-input-inline">
            ...
            <div class="layui-inline" style="width: 85%">
                <input type="text" id="user" name="uname" required  lay-verify="required" placeholder="请输入用户名" autocomplete="off" class="layui-input">
            </div>
            <!-- 对号 -->
